...
class NewUserViewController: UIViewController {
    ...
    @IBAction func EnterPressed(_ sender: UIButton) {
        ...
        if(CoreDataHandler.saveUser(username: username, password: password, admin: false, firstName: firstName, lastName: lastName)){
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NewUserView.layer.cornerRadius = NewUserView.frame.height / 5
